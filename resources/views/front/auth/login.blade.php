            ...
            <div class="block block-rounded mb-0">
                <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                        <a class="btn-block-option fs-sm" href="{{ route('front.resetPassword') }}">{{ __('Forgot Password?') }}</a>
                    </div>
                </div>
                <div class="block-content">
                    <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
                        ...
                        @endif
                        <form class="js-validation-signin" action="{{ route('front.login') }}" method="POST">
                            @csrf
                            <div class="py-3">
                                <div class="mb-4">
